...
window.Cards = (function () {
  ...
  function unit(o) {
    return {
      ...
      /* Which frame of art/sprites/units.png is this unit's portrait. Keyed to
         the id in tools/build-sprites.mjs rather than to a position in this
         list, so reordering the roster cannot silently reshuffle every face. */
      sprite: o.sprite,
    };
  }
  ...
  var UNITS = [
    ...
    unit({ id: 'sov-ash', sprite: 0, name: 'Roderic of Ashfell', cls: 'Sovereign', at: 'sword', cost: 0,
    ...
    unit({ id: 'sov-ivory', sprite: 1, name: 'Maren Ivorywatch', cls: 'Sovereign', at: 'lance', cost: 0,
    ...
    unit({ id: 'sov-storm', sprite: 2, name: 'Calyx Vell', cls: 'Sovereign', at: 'ember', cost: 0,
    ...
    unit({ id: 'bannerguard', sprite: 10, name: 'Hollis Marne', cls: 'Bannerguard', at: 'sword', cost: 4,
    ...
    // ── Reach
    unit({ id: 'marksman', sprite: 11, name: 'Wren Fairlight', cls: 'Marksman', at: 'bow', cost: 3,
    ...
    unit({ id: 'shade', sprite: 12, name: 'Cass Rill', cls: 'Shade', at: 'bow', cost: 2,
    ...
    unit({ id: 'skyguard', sprite: 13, name: 'Ivette Larke', cls: 'Skyguard', at: 'lance', cost: 4,
